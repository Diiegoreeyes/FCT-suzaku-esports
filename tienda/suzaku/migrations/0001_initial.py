# Generated by Django 5.1.6 on 2025-04-01 10:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='EquipoCompetitivo',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=100, null=True)),
                ('logo', models.ImageField(blank=True, null=True, upload_to='equipos_competitivos/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('victorias', models.PositiveIntegerField(default=0, null=True)),
                ('derrotas', models.PositiveIntegerField(default=0, null=True)),
                ('competicion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='equipos', to='suzaku.competicion')),
                ('equipo_competitivo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='participaciones', to='suzaku.equipocompetitivo')),
            ],
        ),
        migrations.AddField(
            model_name='competicion',
            name='juego',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='competiciones', to='suzaku.juego'),
        ),
        migrations.CreateModel(
            name='Partido',
            fields=[
                ...
                ('competicion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='partidos', to='suzaku.competicion')),
                ('equipo1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='partidos_como_equipo1', to='suzaku.equipoparticipante')),
                ('equipo2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='partidos_como_equipo2', to='suzaku.equipoparticipante')),
            ],
        ),
        migrations.CreateModel(
            name='Pedido',
